...
owned_router! {
    pub fn router, ROUTES {
        "POST" post "/dispatchers/register" => register_dispatcher;
        "GET" get "/dispatchers" => list_dispatchers;
        "DELETE" delete "/dispatchers/{dispatcher_id}" => deregister_dispatcher;
    }
}
